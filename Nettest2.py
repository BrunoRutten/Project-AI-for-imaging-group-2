...
def get_model():
    ...
    model.add(MobileNetBlock(filters = 64, strides = 1))
    model.add(MobileNetBlock(filters = 128, strides = 2))
    model.add(MobileNetBlock(filters = 128, strides = 1))
    model.add(MobileNetBlock(filters = 256, strides = 2))
    model.add(MobileNetBlock(filters = 256, strides = 1))
    model.add(MobileNetBlock(filters = 512, strides = 2))

    model.add(MobileNetBlock(filters = 512, strides = 1))
    model.add(MobileNetBlock(filters = 512, strides = 1))
    model.add(MobileNetBlock(filters = 512, strides = 1))
    model.add(MobileNetBlock(filters = 512, strides = 1))
    model.add(MobileNetBlock(filters = 512, strides = 1))

    model.add(MobileNetBlock(filters = 1024, strides = 2))
    model.add(MobileNetBlock(filters = 1024, strides = 1))
